...
import { addPortfolioClient, addPortfolioGallery, addPortfolioServices, deletePortfolioItem, getPortfolio, getUserPortfolio, createUserPortfolio, updateUserPortfolio } from "../controllers/userPortfolio.controller.js";
...
router.route('/add-portfolio-gallary/:id').patch(verifyJWT, portfolioUpload.array("data"), addPortfolioGallery);
