...
router.route('/add-plan').post(verifyJWT, authAdmin, validatePlan, addPlan);
router.route('/get-plan').get(verifyJWT, getPlans);
router.route('/get-plan/:id').get(verifyJWT, getSinglePlan);
router.route('/update-plan/:id').put(verifyJWT, authAdmin, validatePlan, updatePlan)
router.route('/delete-plan/:id').delete(verifyJWT, authAdmin, deletePlan);
